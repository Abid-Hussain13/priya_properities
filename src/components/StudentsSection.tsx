...
const StudentsSection = () => {
  ...
  return (
    <section id="students" className="relative py-32 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 relative z-10">
        <div className="lg:w-1/2">
          ...
          <h2 className="text-7xl font-bebas leading-[0.9] mb-8">
          ...
          <div className="grid grid-cols-2 gap-8 mb-12">
            {areas.map((area, i) => (
              ...
              >
                ...
                <span className="text-xl font-bebas tracking-wide group-hover:text-accent transition-colors">{area}</span>
              </motion.div>
            ))}
          </div>
          ...
          <motion.button 
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-accent text-black px-12 py-5 rounded-full text-xs font-bold uppercase tracking-[0.2em]"
          >
        ...
        <div className="lg:w-1/2 grid grid-cols-2 gap-4">
          <motion.div 
            ...
            className="aspect-[4/5] bg-surface rounded-3xl overflow-hidden mt-12"
          >
          ...
          <motion.div 
            ...
            className="aspect-[4/5] bg-surface rounded-3xl overflow-hidden"
          >

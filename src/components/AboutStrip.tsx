...
const AboutStrip = () => {
  return (
    <section className="bg-surface py-20 md:py-32 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 md:gap-20">
        <div className="w-full lg:w-1/2 relative pb-12 md:pb-0">
          <motion.div 
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            className="w-[85%] md:w-[80%] aspect-square rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl z-10 relative"
          >
          ...
          <motion.div 
            ...
            className="absolute bottom-0 right-0 md:-bottom-10 md:-right-5 w-[60%] aspect-[4/3] rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl z-20 border-4 md:border-8 border-surface"
          >
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            <div className="flex flex-col">
              <span className="text-2xl md:text-3xl font-bebas text-accent">1986</span>
              <span className="text-[10px] uppercase tracking-widest opacity-40">ESTABLISHED</span>
            </div>
            <div className="w-[1px] h-10 bg-border" />
            <div className="flex flex-col">
              <span className="text-2xl md:text-3xl font-bebas text-accent">100%</span>
